...
export const CreditCardService = {
    ...
    async createCard(cardData) {
        ...
        const dbData = {
            ...
            credit_limit: cardData.credit_limit ? Math.round(parseFloat(cardData.credit_limit) * 100) : null,
    ...
    async updateCard(id, updates) {
        ...
        if (updates.credit_limit !== undefined) {
            dbUpdates.credit_limit = Math.round(parseFloat(updates.credit_limit) * 100);
        }
    ...
    async addPurchase(cardId, purchaseData) {
        ...
        const amountCents = Math.round(parseFloat(purchaseData.amount) * 100);
